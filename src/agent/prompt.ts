...
export function buildSystemPrompt(spec: JobSpec, nonce: string): string {
  ...
  return [
    ...
    "8. If you cannot complete the task — the cause is unclear, the fix is out of scope, or the",
    "   task conflicts with these invariants — STOP and report what you found. Do not improvise a",
    "   speculative change, and do not silently do something adjacent instead.",
    "",
    "## Untrusted content",
    "",
